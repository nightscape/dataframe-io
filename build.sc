...
trait DfioModule extends Cross.Module2[String, String] with SbtModule with CiReleaseModule with ScalafmtModule {
  ...
  implicit def resolver[T <: DfioModule]: Resolver[T] = new Resolver[T] {
    def resolve[V <: DfioModule](c: Cross[V]): V = c.valuesToModules(List(crossValue, crossValue2))
  }
}
